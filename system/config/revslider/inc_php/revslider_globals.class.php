<?php
	...
	class GlobalsRevSlider{
		...
		const LINK_HELP_SLIDERS = "https://opencart3x.ru/revolution-slider";
		const LINK_HELP_SLIDER = "https://opencart3x.ru/revolution-slider";
		const LINK_HELP_SLIDE_LIST = "https://opencart3x.ru/revolution-slider";
		const LINK_HELP_SLIDE = "https://opencart3x.ru/revolution-slider";
