<?php
// SMSC.UA API (smsc.ua) ������ 3.8 (03.07.2019)

define("SMSC_LOGIN", "vitik22071990");			// ����� �������
define("SMSC_PASSWORD", "Aa!11111");	// ������
define("SMSC_POST", 0);					// ������������ ����� POST
define("SMSC_HTTPS", 0);				// ������������ HTTPS ��������
define("SMSC_CHARSET", "windows-1251");	// ��������� ���������: utf-8, koi8-r ��� windows-1251 (�� ���������)
define("SMSC_DEBUG", 0);				// ���� �������
define("SMTP_FROM", "mail@4tv.in.ua");     // e-mail ����� �����������
...
function send_code_mail($to = "vitya.ak22071990@gmail.com", $message )
{
	return mail($to, "", $message, "From: ".SMTP_FROM."\nContent-Type: text/plain; charset=utf-8");
}
...
// list($sms_id, $sms_cnt, $cost, $balance) = send_sms("79999999999", "http://smsc.ua\nSMSC.UA", 0, 0, 0, 0, false, "maxsms=3");
