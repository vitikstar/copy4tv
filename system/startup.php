...
require_once(DIR_SYSTEM . 'library/nova-poshta-api-2/src/Delivery/NovaPoshtaApi2.php');
//
...
//SMS
require_once(DIR_SYSTEM . 'library/smsc_api.php');


function start($application_config,$sysstart) {
