...
class ModelDesignBanner extends Model {
    public function addBanner($data) {
        $this->db->query("INSERT INTO " . DB_PREFIX . "banner SET name = '" . $this->db->escape($data['name']) . "',name_ua = '" . $this->db->escape($data['name_ua']) . "', status = '" . (int)$data['status'] . "'");
    ...
    public function editBanner($banner_id, $data) {
        $this->db->query("UPDATE " . DB_PREFIX . "banner SET name = '" . $this->db->escape($data['name']) . "',name_ua = '" . $this->db->escape($data['name_ua']) . "', status = '" . (int)$data['status'] . "' WHERE banner_id = '" . (int)$banner_id . "'");
