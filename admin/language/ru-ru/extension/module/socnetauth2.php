...
$_['heading_title']    = '<a href="https://freeopencart.ru/" target="_blank" title="freeopencart.ru" style="color:#1e91cf;margin-right:5px"><i class="fa fa-user-circle"></i></a>'. $_['page_title'];
// Text
...
$_['help_shop_folder']		= 'Если в домене Вашего магазина есть директория, например: https://site.ru/shop/ то укажите название директории shop без знаков слэш /. Если же в домене вашего магазина нет директории, например https://site.ru/ - то оставьте это поле пустым.';
...
$_['text_contact']	  = '<a href="https://freeopencart.ru">freeopencart.ru</a>';
...
// Error
$_['error_permission']    = 'У Вас нет прав для управления этим модулем!</i></a> 
';
?>