...
// Heading
$_['heading_campaign']                      = 'Умные торговые кампании';
$_['heading_mapping']                       = 'Category Mapping';
$_['heading_merchant']                      = 'Учетная запись Google Merchant Center';
$_['heading_shipping_taxes']                = 'Доставка и налоги';
$_['heading_title']                         = 'Google Покупки';

// Steps
$_['step_campaigns']                        = 'Умные торговые кампании';
$_['step_connect']                          = 'Подключить';
...
$_['entry_adult']                           = 'Содержание только для взрослых';
...
$_['text_acknowledge_cron']                 = 'Я подтверждаю, что я настроил автоматизированную задачу CRON, используя один из методов выше.';
...
$_['text_checklist_acknowledge_0']          = '<h4>Видимость каталога товаров</h4><p>Я подтверждаю, что мой каталог товаров доступен для всех без указания пароля.</p>';
$_['text_checklist_acknowledge_1']          = '<h4>Безопасный процесс оплаты</h4><p>Обработка платежей и транзакций, а также сбор любой конфиденциальной и финансовой личной информации от покупателя осуществляются через защищенный сервер обработки (защищенный SSL, с действующим сертификатом SSL). - https://).</p>';
$_['text_checklist_acknowledge_2']          = '<h4>Политика возврата</h4><p>Я подтверждаю, что мой сайт предоставляет пользователям четкую и заметную политику возврата.</p>';
$_['text_checklist_acknowledge_3']          = '<h4>Условия оплаты</h4><p>Я подтверждаю, что мой сайт предоставляет четкие и заметные условия оплаты.</p>';
$_['text_checklist_acknowledge_4']          = '<h4>Достоверная контактная информация</h4><p>Я подтверждаю, что мой сайт отображает достаточную и точную контактную информацию, содержащую <em>как минимум два</em> типа данных из следующих: номер телефона, фактический адрес, адрес электронной почты.</p>';
$_['text_checklist_intro']                  = '<h3>Важно</h3> Прежде чем вы сможете размещать объявления в Google, ваш магазин <em>должен</em> соответствовать требованиям Google Merchant Center. Полный список всех требований и рекомендаций можно найти <a href="https://support.google.com/merchants/answer/6363310?hl=ru" target="_blank"><strong>здесь</strong></a>.';
$_['text_clicks']                           = 'Clicks';
$_['text_color']                            = 'Color';
$_['text_condition_new']                    = 'New';
$_['text_condition_refurbished']            = 'Refurbished';
$_['text_condition_used']                   = 'Used';
$_['text_connect_intro']                    = 'Расширение Google Покупки не подключено. Пожалуйста, перейдите на сайт <a href="%s" target="_blank"><strong>Google Покупки для OpenCart</strong></a> для получения идентификатора приложения (App ID) и секретный ключ (App Secret).';
...
$_['text_cron_info']                        = 'Обязательно настройте задачу CRON, выполняющуюся <strong>каждый час</strong> одним из следующих способов. Метод № 1 рекомендуется. Работа CRON поможет вам с такими задачами:<br /><br />&bull; Периодическая синхронизация вашего каталога OpenCart с Google Merchant Center<br />&bull; Автоматическая загрузка статусов товаров и отчетов о продуктах';
...
$_['text_merchant_intro']                   = 'Выберите учетную запись для использования:';
$_['text_merchant_website_claim']           = '<p>После того как вы нажмете <strong>Продолжить</strong>, вам будет предложено авторизовать OpenCart для управления вашими данными и аккаунтом в Google Покупках. URL вашего сайта будет запрашиваться выбранной учетной записью Merchant Center.</p>';
$_['text_na']                               = '&ndash;';
...
$_['text_no_targets']                       = 'Кампании не найдены. Нажмите кнопку ниже чтобы добавить вашу первую кампанию';
$_['text_panel_connect']                    = 'Шаг 1 из 5: Подключение расширения Google Покупки';
$_['text_panel_heading']                    = 'Настройка Google Покупок | Магазин: %s';
$_['text_panel_heading_campaign']           = 'Шаг 3 из 5: Настройка умных торговые кампаний';
$_['text_panel_heading_campaign_2']         = 'Настройка умных торговые кампаний';
$_['text_panel_heading_mapping']            = 'Шаг 5 из 5: Настройка Category Mapping';
$_['text_panel_heading_mapping_2']          = 'Настройка Category Mapping';
$_['text_panel_heading_merchant']           = 'Шаг 2 из 5: Настройка учетной записи Google Merchant Center';
$_['text_panel_heading_more_info']          = 'About Campaigns';
$_['text_panel_heading_preview']            = 'Предварительный просмотр объявления - How an Ad Looks Like';
...
$_['text_popup_loading_title']              = 'Загрузка из...';
...
$_['tab_text_reports']                      = 'Отчеты кампаний';
