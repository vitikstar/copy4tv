...
class ControllerNeTemplate extends Controller {
    ...
    public function index() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href'      => $this->url->link('ne/template', 'user_token=' . $this->session->data['user_token'], true)
        );

        $data['edit'] = $this->url->link('ne/template/update', 'user_token=' . $this->session->data['user_token'] . '&id=', true);
        $data['insert'] = $this->url->link('ne/template/insert', 'user_token=' . $this->session->data['user_token'], true);
        $data['delete'] = $this->url->link('ne/template/delete', 'user_token=' . $this->session->data['user_token'], true);
        $data['copy'] = $this->url->link('ne/template/copy', 'user_token=' . $this->session->data['user_token'], true);
        $data['copy_default'] = $this->url->link('ne/template/copy_default', 'user_token=' . $this->session->data['user_token'], true);
        ...
        $this->response->setOutput($this->load->view('ne/template', $data));
    }
    ...
    public function update() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            $this->response->redirect($this->url->link('ne/template', 'user_token=' . $this->session->data['user_token'], true));
        }
    ...
    private function form() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href'      => $template_info ? $this->url->link('ne/template/update', 'user_token=' . $this->session->data['user_token'] . '&id=' . (int)$template_id, true) : $this->url->link('ne/template/insert', 'user_token=' . $this->session->data['user_token'], true)
        );
        ...
        if (!isset($template_id)) {
            $data['action'] = $this->url->link('ne/template/insert', 'user_token=' . $this->session->data['user_token'], true);
        } else {
            $data['action'] = $this->url->link('ne/template/update', 'user_token=' . $this->session->data['user_token'] . '&id=' . $template_id, true);
        }

        $data['cancel'] = $this->url->link('ne/template', 'user_token=' . $this->session->data['user_token'], true);
        ...
        $this->response->setOutput($this->load->view('ne/template_detail', $data));
    }
