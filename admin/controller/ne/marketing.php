...
class ControllerNeMarketing extends Controller
{
    ...
    public function index()
    {
        ...
        $data['subscribe'] = $this->url->link('ne/marketing/subscribe', 'user_token=' . $this->session->data['user_token'] . $url . '&id=', true);
        $data['unsubscribe'] = $this->url->link('ne/marketing/unsubscribe', 'user_token=' . $this->session->data['user_token'] . $url . '&id=', true);
        ...
        $data['action'] = $this->url->link('ne/marketing/add', 'user_token=' . $this->session->data['user_token'], true);
        $data['delete'] = $this->url->link('ne/marketing/delete', 'user_token=' . $this->session->data['user_token'] . $url, true);
        $data['csv'] = $this->url->link('ne/marketing/csv', 'user_token=' . $this->session->data['user_token'] . $url, true);
        ...
        $data['sort_name'] = $this->url->link('ne/marketing', 'user_token=' . $this->session->data['user_token'] . '&sort=name' . $url, true);
        $data['sort_email'] = $this->url->link('ne/marketing', 'user_token=' . $this->session->data['user_token'] . '&sort=email' . $url, true);
        $data['sort_subscribed'] = $this->url->link('ne/marketing', 'user_token=' . $this->session->data['user_token'] . '&sort=subscribed' . $url, true);
        $data['sort_store'] = $this->url->link('ne/marketing', 'user_token=' . $this->session->data['user_token'] . '&sort=store_id' . $url, true);
        $data['sort_language'] = $this->url->link('ne/marketing', 'user_token=' . $this->session->data['user_token'] . '&sort=language_code' . $url, true);
        ...
        $pagination->url = $this->url->link('ne/marketing', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
        ...
        $this->response->setOutput($this->load->view('ne/marketing', $data));
    }
    ...
    public function unsubscribe()
    {
        ...
        $this->response->redirect($this->url->link('ne/marketing', 'user_token=' . $this->session->data['user_token'] . $url, true));
    }
