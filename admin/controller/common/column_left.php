...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			$fast[] = array(
				'name' => 'Настраиваемый подвал',
				'href' => $this->url->link('extension/module/sirius_custom_footer', 'user_token=' . $this->session->data['user_token'], true),
				'children' => array(),
			);
			...
			if ($this->user->hasPermission('access', 'setting/setting')) {
                $fast[] = array(
					'name'	   => 'Настройки магазина(адрес,карта...)',
					'href'     => $this->url->link('setting/setting', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			if ($this->user->hasPermission('access', 'extension/module/oct_megamenu')) {
                $fast[] = array(
					'name'	   => 'Мегаменю',
					'href'     => $this->url->link('extension/module/oct_megamenu', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			if ($this->user->hasPermission('access', 'polling/management')) {
                $fast[] = array(
					'name'	   => 'Опрос',
                ...
                $fast[] = array(
					'name'	   => 'Телефоны',
					'href'     => $this->url->link('extension/module/html', 'user_token=' . $this->session->data['user_token'].'&module_id=56', true),
					'children' => array()
				);
                $fast[] = array(
					'name'	   => 'Шапка. Телефон и время работы',
					'href'     => $this->url->link('extension/module/html', 'user_token=' . $this->session->data['user_token'].'&module_id=36', true),
					'children' => array()
				);
