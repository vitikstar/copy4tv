...
class ControllerDesignBanner extends Controller {
    ...
    protected function getForm() {
        ...
        if (isset($this->error['name_ua'])) {
            $data['error_name_ua'] = $this->error['name_ua'];
        } else {
            $data['error_name_ua'] = '';
        }
        ...
        if (isset($this->request->post['name_ua'])) {
            $data['name_ua'] = $this->request->post['name_ua'];
        } elseif (!empty($banner_info)) {
            $data['name_ua'] = $banner_info['name_ua'];
        } else {
            $data['name_ua'] = '';
        }
    ...
    protected function validateForm() {
        ...
        if ((utf8_strlen($this->request->post['name_ua']) < 3) || (utf8_strlen($this->request->post['name_ua']) > 64)) {
            $this->error['name_ua'] = $this->language->get('error_name');
        }
