...
//	    $arr = array(
//            300001=>'нниц',
//300002=>'Волинська область',
//300003=>'Дніпропетровська область',
//300004=>'Донецька область',
//300005=>'Житомирська область',
//300006=>'Закарпатська область',
//300007=>'Запорізька область',
//300008=>'Івано-Франківська область',
//300009=>'Київська область',
//300010=>'Кіровоградська область',
//300011=>'Луганська область',
//300012=>'Львівська область',
//300013=>'Миколаївська область',
//300014=>'Одеська область',
//300015=>'Полтавська область',
//300016=>'Рівненська область',
//300017=>'Сумська область',
//300018=>'Тернопільська область',
//300019=>'Харківська область',
//300020=>'Херсонська область',
//300021=>'Хмельницька область',
//300022=>'Черкаська область',
//300023=>'Чернівецька область',
//300024=>'Чернігівська область'
//    );
//	    $query = $this->db->query("SELECT * FROM `oc_address`");
//	    foreach ($query->rows as $row){
//	        $country_id = (isset($arr[$row['country_id']])) ? $arr[$row['country_id']] : 0;
//	        $sql="UPDATE `oc_address` SET country_id='".$country_id."' WHERE address_id='".$row['address_id']."'";
//           echo $sql;
//           echo"<br>";
//	         $this->db->query($sql);
//        }
