...
//end revsslider custom code
	...
	public function install(){
		...
		$this->model_setting_setting->editSetting('module_revslideropencart', array('module_revslideropencart_status' => 1));

		$htafile = DIR_SYSTEM.'.htaccess';
	...
	public function uninstall(){
		$this->load->model('setting/setting');
		$this->model_setting_setting->editSetting('module_revslideropencart', array('module_revslideropencart_status' => 0));
		$this->load->model('module/revslideropencart');
    ...
    public function price_format($price = ''){
        $price = $this->currency->format($price, $this->config->get('config_currency'), 1, true);
        return $price;
    }
}
?>