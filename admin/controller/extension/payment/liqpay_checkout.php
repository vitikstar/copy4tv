...
class ControllerExtensionPaymentLiqPayCheckout extends Controller
{
    ...
    public function index()
    {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/payment/liqpay_checkout', 'user_token=' . $this->session->data['user_token'], 'SSL')
        );

        $data['action'] = $this->url->link('extension/payment/liqpay_checkout', 'user_token=' . $this->session->data['user_token'], 'SSL');
