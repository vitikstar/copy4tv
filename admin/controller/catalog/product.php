...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['super_price'])) {
			$data['super_price'] = $this->request->post['super_price'];
		} elseif (!empty($product_info)) {
			$data['super_price'] = $product_info['super_price'];
		} else {
			$data['super_price'] = '';
		}
		...
		if (isset($this->request->post['video_hash_youtube'])) {
			$data['video_hash_youtube'] = $this->request->post['video_hash_youtube'];
		} elseif (!empty($product_info)) {
			$data['video_hash_youtube'] = $product_info['video_hash_youtube'];
		} else {
			$data['video_hash_youtube'] = '';
		}

        $data['entry_video_hash_youtube'] = $this->config->get('entry_video_hash_youtube');
        $data['tab_video_hash_youtube'] = $this->config->get('tab_video_hash_youtube');
		...
		if (isset($this->request->post['metka_id'])) {
			$data['metka_id'] = $this->request->post['metka_id'];
		} elseif (isset($product_info['metka_id'])) {
            if(!empty($product_info['metka_id'])) $data['metka_id'] = $product_info['metka_id'];
            else $data['metka_id'] = 'empty';
		} else {
			$data['metka_id'] = 'empty';
		}
