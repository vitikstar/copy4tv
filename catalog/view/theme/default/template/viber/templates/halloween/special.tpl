    ...
    <tr>
        <td style="padding-top:15px;">
            <table border="0" cellspacing="0" cellpadding="0" style="width:100%;">
                <tbody>
                <tr>
                    <td style="background: url(<?php echo HTTP_SERVER; ?>catalog/view/theme/default/template/ne/templates/halloween/images/product.jpg) repeat-x;color:<?php echo $heading_color; ?>;<?php echo $heading_style; ?>" height="32" width="100%">
                        <!--[if gte mso 9]>
