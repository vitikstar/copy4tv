                    ...
                    <td>
                        <a href="<?php echo $product['href']; ?>" title="<?php echo $product['name']; ?>"
                           target="_blank"><img src="<?php echo $product['thumb']; ?>"
                                                ...
                                                style="background:#fff;padding:14px 20px;"></a>
                    </td>
                </tr>
                <tr>
    ...
    <tr>
        <td style="padding-bottom:12px;">
            <table border="0" cellspacing="0" cellpadding="0" style="width:100%;">
                <tbody>
                <tr>
                    <td style="background: url(<?php echo HTTP_SERVER; ?>catalog/view/theme/default/template/ne/templates/summer/images/productbot.jpg) repeat-x;" height="32" width="100%">
                        <!--[if gte mso 9]>
                        <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false"
                                style="width:100%;height:32px;">
                            <v:fill type="tile"
                                    src="<?php echo HTTP_SERVER; ?>catalog/view/theme/default/template/ne/templates/summer/images/productbot.jpg"/>
