...
class ControllerApiOrder extends Controller {
	...
	public function history() {
		...
		if(isset($this->request->get['api_id']))  $this->session->data['api_id'] = $this->request->get['api_id'];
		...
		if (!isset($this->session->data['api_id'])) {
			...
			if ($order_info) {
				$this->model_checkout_order->addOrderHistory($order_id, 7, $this->request->post['comment'], $this->request->post['notify'], $this->request->post['override']);
