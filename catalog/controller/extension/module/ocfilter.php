...
class ControllerExtensionModuleOCFilter extends Controller {
  ...
  public function callback() {
    ...
    $json['text_total'] = $this->declOfNum($total_products, array(
      ...
      /**
       * sort mobile modification
       */

      $this->session->data['text_total_filter'] = $this->declOfNum($total_products, array(
          $this->language->get('text_total_filter_1'),
          $this->language->get('text_total_filter_2'),
          $this->language->get('text_total_filter_3')
      ));

      /**
       * sort mobile modification end
       */
