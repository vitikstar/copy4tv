	...
	public function add() {
		...
		if ($product_info) {
            if (!$json) {
				...
				if (empty($this->request->post['one_click_name'])) {
					$json['error']['one_click_name'] = $this->language->get('error_one_click_name');
				}
				...
				if(!isset($json['error'])){
                    ...
                    $telephone_form = strtr($this->request->post['telephone'],array('+',' ','-','(',')'));

                    ($this->customer->isLogged()) ? $customer_id = $this->customer->getId() : 0;


                    $order_data['customer_id'] = $customer_id;
                    $order_data['customer_group_id'] = 1;
                    $order_data['firstname'] = 'Заказ в 1 клик';
                    $order_data['lastname'] = $this->request->post['one_click_name'];
                    $order_data['email'] = $this->config->get('config_email');
                    $order_data['telephone'] = $telephone_form;
                    $order_data['fax'] = '';
