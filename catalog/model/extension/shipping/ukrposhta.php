...
class ModelShippingUkrPoshta extends Model {
	...
	function getQuote($address) {
		...
		if (is_array($this->settings['shipping_methods'])) {
            $shipping_methods = sort($this->settings['shipping_methods']);
	...
	private function getDeliveryPeriod($delivery_type, $zone_id) {
	    if ($zone_id == $this->settings['sender_region']) {
            ...
            $period = (isset($this->settings['tariffs'][$delivery_type]['ukraine_delivery_period'])) ? $this->settings['tariffs'][$delivery_type]['ukraine_delivery_period'] : '';
        }
