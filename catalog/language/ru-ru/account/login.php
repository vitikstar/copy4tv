...
// Error
$_['error_login']                  = 'Пароль указан неправильно.';
...
$_['error_empty_password']               = 'Пароль в базе пустой (скорее всего Вы выполняли вход с помощью социальной сети). Введите новый пароль.';
$_['repeat_password']               = 'Повторите пароль';
$_['error_passwords_not_match']               = 'Пароли не совпадают';